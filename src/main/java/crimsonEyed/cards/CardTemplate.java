...
public class CardTemplate extends AbstractDynamicCard {
    ...
    public static final String ID = SasukeMod.makeID("DefaultCommonSkill");
    // public static final String ID = DefaultMod.makeID(${NAME}.class.getSimpleName());public static final String ID = DefaultMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
