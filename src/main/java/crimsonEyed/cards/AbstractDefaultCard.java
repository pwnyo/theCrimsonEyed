...
public abstract class AbstractDefaultCard extends CustomCard {
    ...
    public int magicNumber2;        // Just like magic number, or any number for that matter, we want our regular, modifiable stat
    public int baseMagicNumber2;    // And our base stat - the number in it's base state. It will reset to that by default.
