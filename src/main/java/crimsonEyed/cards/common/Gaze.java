...
public class Gaze extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Gaze.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    private static final int UPGRADE_PLUS_LOCKON = 1;
    ...
    public Gaze() {
        ...
        baseMagicNumber = magicNumber = LOCKON;
    }
    ...
    public void upgrade() {
        if (!upgraded) {
            ...
            upgradeMagicNumber(UPGRADE_PLUS_LOCKON);
