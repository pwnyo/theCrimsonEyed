...
public class CloseWatch extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(CloseWatch.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
