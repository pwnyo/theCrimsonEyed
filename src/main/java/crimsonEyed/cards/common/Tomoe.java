...
public class Tomoe extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(Tomoe.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        this.addToBot(new RandomLockOnAction(randomMonster, 1, this.magicNumber));// 43
    }
