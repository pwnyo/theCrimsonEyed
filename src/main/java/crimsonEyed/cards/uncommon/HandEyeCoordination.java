...
public class HandEyeCoordination extends AbstractDynamicCard {

    // TEXT DECLARATION

    public static final String ID = DefaultMod.makeID(HandEyeCoordination.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
