...
public class SureFire extends AbstractDynamicCard {
    ...
    public static final String ID = DefaultMod.makeID(SureFire.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String IMG = makeCardPath("Attack.png");// "public static final String IMG = makeCardPath("SureFire.png");
