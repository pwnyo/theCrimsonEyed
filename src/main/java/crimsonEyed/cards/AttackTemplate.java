...
public class AttackTemplate extends AbstractDynamicCard {
    ...
    public static final String ID = SasukeMod.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
    ...
    public AttackTemplate() { // public ${NAME}() - This one and the one right under the imports are the most important ones, don't forget them
