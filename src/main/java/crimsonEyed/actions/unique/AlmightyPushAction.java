...
public class AlmightyPushAction extends AbstractGameAction {
    ...
    public void update() {
        ...
        addToBot(new VFXAction(new BlizzardEffect(amount * 2, AbstractDungeon.getMonsters().shouldFlipVfx())));
        addToBot(new ShakeScreenAction(0.0F, ScreenShake.ShakeDur.XLONG, ScreenShake.ShakeIntensity.HIGH));
        addToBot(new DamageAllEnemiesAction(AbstractDungeon.player, amount * theSize, DamageInfo.DamageType.NORMAL, AbstractGameAction.AttackEffect.SMASH));
